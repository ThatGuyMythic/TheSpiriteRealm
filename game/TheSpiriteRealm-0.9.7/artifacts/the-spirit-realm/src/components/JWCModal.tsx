  ...
  function renderEnemies(compact?: boolean) {
    ...
    return (
      <div style={{ display: "flex", flex: 1, minHeight: 0, gap: compact ? 3 : 6, overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "row-reverse", gap: compact ? 2 : 4, alignItems: "flex-end", overflow: "hidden", maxHeight: compact ? 216 : 300 }}>
          {jwc.enemies.map((e, i) => {
            const isDead    = e.hp <= 0;
            const isTarget  = i === jwc.active;
            const atkN      = atkByEnemy[i] ?? 0;
      ...
      <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            height: 240, flexShrink: 0, marginTop: 8,
          }}>
            <div
