  ...
  function renderEnemies(compact?: boolean) {
    ...
    return (
      <div style={{ display: "flex", flex: 1, minHeight: 0, gap: compact ? 3 : 6, overflow: "hidden" }}>
        ...
        {/* RIGHT SECTION: all sprites side by side — anchored to TOP, capped to player-size height */}
        <div style={{ flex: 1, display: "flex", gap: compact ? 2 : 4, alignItems: "flex-start", overflow: "hidden", maxHeight: compact ? 72 : 100 }}>
          {jwc.enemies.map((e, i) => {
            const isDead    = e.hp <= 0;
            const isTarget  = i === jwc.active;
            const atkN      = atkByEnemy[i] ?? 0;
      ...
      <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            height: 80, flexShrink: 0, marginTop: 8,
          }}>
            <div
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          display: "flex", flexDirection: "row", alignItems: "flex-end",
          height: 110, flexShrink: 0, marginTop: 16,
        }}>
          <div
            className={playerAnim.getClass("player", "jwc-shield-block") || playerAnim.getClass("reserve", "jwc-reserve-pulse")}
